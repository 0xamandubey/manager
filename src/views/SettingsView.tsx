...
interface SettingsViewProps {
  ...
  renameBranch: (id: number, newName: string) => Promise<any>;
...
export function SettingsView({ 
  ...
  const handleSaveBranchRename = async (id: number) => {
      ...
      printWindow.document.write(`
        <html>
          ...
          <body>
            ...
            <div class="footer">
              Generated by Staff Attendance PWA Portal
            </div>
            <script>
      ...
      <div className="glass-card rounded-2xl p-5 shadow-sm border border-stone-200/40 dark:border-stone-850/40 flex items-start gap-4">
        ...
        <div className="flex flex-col gap-1.5">
          <h4 className="text-xs font-bold text-stone-850 dark:text-stone-100">
            About Staff Attendance Management
          </h4>
